...
const parcelAPIURL = 'https://papi.parcelroblox.com/whitelist/remove';
...
const command: SlashCommand = {
  command: new SlashCommandBuilder()
    ...
    .setDescription("Revokes said User's License to the stated File."),
  execute: async (interaction: ChatInputCommandInteraction) => {
    ...
    try {
      ...
      const ackMessage = await interaction.reply("Revoking in progress...");
      ...
      const updatedMessage = `Revoked ${selectedProduct} for player (${robloxID})`;
